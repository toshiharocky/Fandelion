@extends('layouts.host_menu_mobnav')
...
<div id="history-wrapper" style="display:flex;flex-direction:column;align-items: center;">
    <div class="col-lg-8 col-md-12 tabs-wrapper">
        <!-- Listing Nav -->
        <ul class="tabs-nav">
			<li id="waiting" class="active"><a href="#history-nav1">ホストの確認待ち</a></li>
			<li id="future_bookings"><a href="#history-nav2">今後の予約</a></li>
			<li id="past_bookings"><a  href="#history-nav3">過去の予約</a></li>
		</ul>
	    ...
	    <!--<div class="margin-top-0">-->
		    ...
		    <div class="tab-content" id="history-nav3"></div>
			<!--</ul>-->
    	</div>
    </div>
</div>
...
<script>
    ...
    $("#history-nav3").on("click",function(){
        $("#future_bookings").addClass("active");
        $("#past_bookings").removeClass("active");
        console.log($("#future_bookings").hasClass("active"));
        console.log($("#past_bookings").hasClass("active"));
