				...
				<div class="col-md-12">
					<a id="gym" onclick="document:gym_select.submit(); return false;" class="listing-item-container" data-marker-id="0">
						...
						<div class="listing-item">
							<img src="https://s3-ap-northeast-1.amazonaws.com/fandelion/${sort_filter[0].img_url}" alt="">
				...
				`
					...
					<div class="col-md-12">
						<a id=${id_gym} onclick=${onclick} class="listing-item-container" data-marker-id=$i>
							...
							<div class="listing-item">
								<img src="https://s3-ap-northeast-1.amazonaws.com/fandelion/${sort_filter[$i].img_url}" alt="">
								<div class="listing-item-content">
